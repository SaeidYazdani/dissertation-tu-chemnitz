...
- Required LaTeX package for PDF/A builds: `pdfx`
...
The PDF/A output is written to:
...
--pdfa                  Build PDF/A-2b output as out/main-pdfa.pdf
...
├── main-pdfa.tex                    Wrapper source for PDF/A builds
├── main-pdfa.xmpdata                PDF/A metadata used by the pdfx package
...
- The [Inkscape](https://inkscape.org/) authors and contributors. Inkscape was
  used extensively to create circuit schematics and figures.
- The creator of the
...
- The creators and maintainers of
  [LaTeX](https://www.latex-project.org/) and the many LaTeX packages used in
  this project.
